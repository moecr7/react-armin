...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-b from-blue-900 to-slate-900 text-white p-6 rounded-t-3xl" dir="rtl">
      <div className="container mx-auto max-w-md">
        {/* Inner Card */}
        <div className="bg-gradient-to-b from-blue-900 to-slate-900 rounded-3xl p-8">
